...
### Example Map View
Here is an example of using the data to display all bus stops on a map. Click on a <img src="/img/bus-stop.png" height="15" width="15" /> icon for more information.

<BusStopMap />

Blue (Bus Stop) &bull; Yellow (Bus Stop with Shelter)