  ...
  "results": [
    {
      ...
      "updatedAt": "2024-07-01T13:01:55.000Z",
...
### Example Map View
Here is an example of using the data to display all public toilets on a map. Click on a <img src="/img/toilet.png" height="15" width="15" /> icon for more information.
